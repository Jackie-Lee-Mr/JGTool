...
@property (nonatomic, strong) JGTextField *passwordField;
...
@property (nonatomic, strong) JGPasswordErrorView *errorView;
...
- (void)showInView:(UIView *)view{
    ...
    self.backView.frame = CGRectMake(0, view.height, view.width, 400);
    [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionTransitionNone animations:^{
        self.backView.frame = CGRectMake(0, view.height-400, view.width, 400);
...
- (void)showPasswordErrorWithLimit:(NSInteger )limit{
    [self stopLoading];
    self.errorView = [[JGPasswordErrorView alloc] init];
...
- (JGTextField *)passwordField{
    if (_passwordField == nil){
        _passwordField = [[JGTextField alloc] init];
