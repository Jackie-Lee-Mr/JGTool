...
@implementation UINavigationBar (QJAlpha)
...
{
    if (!self.overlay) {
        self.overlay = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, CGRectGetHeight(self.bounds) + IphoneXHeight + 20)];
//        JGLog(@"alloc overLay");
